...
I am a CS senior who has shipped small projects in Python (Flask, pygame, scikit-learn and PyTorch for ML coursework) and some Dart/Flutter. I am comfortable reading and writing Python and JavaScript, and I teach beginner programming, so I care about clear docs and error messages. I want to get better at working inside an unfamiliar codebase, writing tests, and following a project's review process. Prefer Python or docs-heavy issues; avoid issues that need deep frontend framework knowledge or infrastructure setup I cannot run locally.
